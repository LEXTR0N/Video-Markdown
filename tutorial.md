...
## Slide (title="Ein Modul in einem Studium", lang="DE")
...
## Slide (title="A module in a course of study", lang="EN")
...
## Teleprompt (title="A module in a course of study", lang="EN")
...
## Slide (title="Häufige Form: Seminaristischer Unterricht", lang="DE")
...
### Button (time="AM", label="Git-Repo", action="https://github.de") 
...
## Slide (title="Aufwand für ein Modul", lang="DE")
...
## Slide (title="Typische Verteilung von Präsenz- und Selbstlernzeit", lang="DE")
- 5 ECTS = 150 Stunden Aufwand

- 60 Stunden in Präsenz = 4 Stunden pro Woche
- 90 Stunden Selbststudium

## Quiz (name="quiz1", title="Flipped Classroom Verständnis")
...
## Teleprompt (title="Typische Verteilung von Präsenz- und Selbstlernzeit", lang="DE")
...
## Teleprompt (title="Show things on Screencast", lang="DE")
...
Vorwissen für die kommenden Lehrveranstaltungen. In den Videos haben Sie zudem die Möglichkeit, Quizfragen zu beantworten und Übungen durchzuführen. Denn es ist wichtig,
...
auseinanderzusetzen und Ihre eigene Lernstrategie zu entwickeln. Solch eine Selbstverantwortung sollte sich positiv auf Ihre Motivation und Ihr Selbstbewusstsein auswirken, und Sie auf Ihren weiteren akademischen Weg sowie Ihre berufliche Karriere gut vorbereiten.


# Scene: Code Snippet & Marker Demonstration

## Slide (title="Code Snippet & Marker Demonstration", lang="DE")
...
## Teleprompt (title="Code Snippet & Marker Demonstration", lang="DE")
...
Am Ende, in Zeile [!line:gcdFunction-return], geben wir da s Ergebnis zurück.  

# Scene: Informatives Video

## Video (source="video.mp4")

## Telepromt (title="Informatives Video, lang="DE")
Und nun haben wir noch ein informatives Video, weshalb ich Sie bitten möchte Aufmerksam zuzuschauen.


# Scene: Schöne Bilder

## Slide (title="Schöne Bilder", lang="DE")

Hier eine Bild von einer Blume
### Image (source="image.png")
Das wars auch schon

## Telepromt (title="Schöne Bilder", lang="DE")
Nach unserem Video möchte ich Sie nochmals dazu auffordern auf dieses Bild zu schauen.
